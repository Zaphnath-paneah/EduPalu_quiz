...
qst[n][5]=2;//[lettre correspondant à la réponse correcte( A,B,C,D)]
...
qst[n][10]=15;//délai pour répondre à la question
...
qst[n][5]=1;//[lettre correspondant à la réponse correcte( A,B,C,D)]
...
qst[n][4]="Un moustique.";//proposition D
qst[n][5]=4;//[lettre correspondant à la réponse correcte( A,B,C,D)]
